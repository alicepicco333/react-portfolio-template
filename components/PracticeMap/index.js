...
const NODES = [
  ...
  { id: "ur", label: "User research", p: [-0.2, -0.85, 0.55], work: ["0", "11"] },
  ...
  { id: "hci", label: "HCI", p: [0.15, -0.55, 0.35], work: ["0", "1"] },
  { id: "ux", label: "UX design", p: [0.55, -0.8, 0.15], work: ["0", "11"] },
  { id: "ixd", label: "Interaction design", p: [0.35, -0.05, 0.75], work: ["0", "11", "3"] },
